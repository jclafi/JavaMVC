...
public class TelaLogin extends JDialog {
	...
	public void setObjUsuarioRegras(Usuario objUsuario) {
		this.objUsuarioRegras = objUsuario;
	}
	...
	private boolean validaLogin(String user, String passWord) {
		...
		if (objUsuarioRegras.validaLogin(user, passWord)) {
			RequestDispatcher.setUsuarioLogado(objUsuarioRegras.getCd_usuario());
			RequestDispatcher.setNomeUsuarioLogado(objUsuarioRegras.getNome());
			return true;
		} else
			return false;
